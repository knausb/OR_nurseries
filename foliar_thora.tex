...
\end{center}
\caption{
Gel image demostrating diagnostic differences among \emph{Phytophthora} taxa. PCR amplicons of the internal transcribed spacer region was digested with the enzyme \emph{Aci}I and resolved on a 2\% agarose gel.  A 1kb-plus DNA ladder is shown in lane 1.
%%should be left justified, as specified by the options to the caption 
%package.
}
\label{fig:gel}
...
% Fri Jan  3 14:02:17 2014
\begin{table}[ht]
\centering
\caption{\emph{Phytophthora} taxa counts for Oregon nurseries} 
...
% latex table generated in R 3.0.2 by xtable 1.7-1 package
% Fri Jan  3 13:51:28 2014
\begin{table}[ht]
\centering
\caption{Hierachical partitioning of Shannon-Wiener diversity. Only nurseries which were sampled during two seasons were used (nurseries A, D, E, F, H and I).} 
\label{tab:adipart}
...
gamma & Total & 1.368 & 0.000 & 1.368 & 1.368 & 1.368 & 1.368 & 1.000 \\ 
  alpha.2 & Within nursery & 0.853 & -54.086 & 1.322 & 1.304 & 1.323 & 1.337 & 0.001 \\ 
  alpha.1 & Within season & 0.671 & -53.959 & 1.282 & 1.258 & 1.283 & 1.302 & 0.001 \\ 
  beta.2 & Among nursery & 0.515 & 54.086 & 0.046 & 0.032 & 0.045 & 0.064 & 0.001 \\ 
  beta.1 & Among season & 0.183 & 17.093 & 0.040 & 0.026 & 0.039 & 0.057 & 0.001 \\ 
   \hline
\end{tabular}
\end{table}
